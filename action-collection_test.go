...
func TestFilterToListChangeActions(t *testing.T) {
	...
	ac[2] = &Action{Type: "updateCard", Data: &ActionData{Card: &Card{Closed: true}}} // Card was archived
	ac[3] = &Action{Type: "updateCard", Data: &ActionData{Old: &Card{Closed: true}}}  // Card was unarchived
